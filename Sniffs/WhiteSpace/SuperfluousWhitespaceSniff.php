<?php
class ezpnext_Sniffs_WhiteSpace_SuperfluousWhitespaceSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === T_OPEN_TAG) {
            ...
            */
            ...
            if (isset($tokens[($stackPtr - 2)], $tokens[($stackPtr - 1)]) && $tokens[($stackPtr - 1)]['line'] < $tokens[$stackPtr]['line'] && $tokens[($stackPtr - 2)]['line'] === $tokens[($stackPtr - 1)]['line']) {
                ...
                if ($lines > 1) {
                    $error = 'File must not contain multiple empty lines in a row; found %s empty lines';
                    $data  = array($lines);
